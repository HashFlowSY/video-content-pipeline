...
- [x] All five branches complete plan/run/status/verify/inventory
- [x] pause/resume, cancel, and improve each exercised against real runs
- [x] improve carry-forward verified against the published source bundle
- [x] Standing guarantees asserted; no expert-command re-acceptance
- [x] Full suite green within the ≤ 5-minute budget
